  ...
  ({ className, title, description, footer, danger = false, children, ...props }, ref) => (
    ...
    >
      <div className={cn('p-5', children != null ? 'pb-1' : 'pb-4')}>
        <h3 className={cn('text-sm font-semibold leading-none tracking-tight', danger && 'text-danger')}>{title}</h3>
 ...
 * Pass `children` to override the default text (e.g. "Saved 2 minutes ago").
 */
